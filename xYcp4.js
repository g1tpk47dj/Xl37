    ...
    <div style="pointer-events:auto;background:#fff;border:1px solid #e5e7eb;box-shadow:0 8px 24px rgba(0,0,0,.12);
      ...
      <div style="display:flex;gap:8px;align-items:center">           
        <button id="pwa-install-later" type="button"   
          style="display:none;background:#fff;border:1px solid #e5e7eb;color:#0f172a;border-radius:10px;padding:7px 12px;font-size:12px;cursor:pointer">Nanti</button>                 
...
function isIosSafari() {   
  return /iphone|ipad|ipod/i.test(navigator.userAgent) && /^((?!chrome|android).)*safari/i.test(navigator.userAgent); 
} 
